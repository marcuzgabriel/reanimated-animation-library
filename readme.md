...
| #react-native-gesture-handler | all | react-native-gesture-handler onEnd state doesn't recognize translation.y.value you have to use the extracted values. |
