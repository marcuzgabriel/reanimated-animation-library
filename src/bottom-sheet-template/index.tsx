...
export class BottomSheet extends Component<Record<string, unknown>, BottomSheetState> {
  ...
  private onRegisterLastScroll: (event: NativeSyntheticEvent<NativeScrollEvent>) => void;
  ...
  private onHeaderHandlerStateChange = ({ nativeEvent }: PanGestureHandlerStateChangeEvent) => {
